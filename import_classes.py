...
def import_oldsecond(name):
    ...
    try:
        ...
        with data.database() as db:
            ...
            count = 0
            existing = db.execute('''SELECT * FROM transactions WHERE account = 'Checking' ''').fetchall()
        ...
        click.echo('UPLOAD FAILED: File needed for upload not found. Check existence of file or file name.')
...
def import_chase(name, data_location):
    ...
    try:
        ...
        click.echo('UPLOAD FAILED: Table in database was not found. Check existence of database or table.')
        click.echo(f'ERROR MESSAGE: {e}')
